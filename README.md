...
- A manifest with fullscreen display mode removes browser-provided toolbar UI for an installed Home Screen web app, while iOS remains responsible for its system status indicators: [What’s new in web apps](https://developer.apple.com/videos/play/wwdc2023/10120/).
