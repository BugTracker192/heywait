...
- Core Image provides direct JPEG rendering from the captured image graph for Browser mode: [`CIContext.jpegRepresentation`](https://developer.apple.com/documentation/coreimage/cicontext/jpegrepresentation(of:colorspace:options:)).
